...
FigPathUnit = [FigPath,'\egunit' num2str(egunit) '_'];%['B:\AMSalicylate Paper\example_units\example_unit' num2str(egunit) '\egunit' num2str(egunit) '_'];
...
L.Renderer = "painters";
saveas(L,[FigPathUnit 'raster_baseline.pdf']);
...
R.Renderer = "painters";
saveas(R,[FigPathUnit 'raster_salicylate.pdf']);
...
saveas(C,[FigPathUnit 'CycHist.pdf']);
...
saveas(DV,[FigPathUnit 'dP_temporal.pdf']);
...
saveas(F,[FigPathUnit 'firing_rate.pdf']);
...
ylabel(a,'d''_{rate}');
saveas(DF,[FigPathUnit 'dP_rate.pdf']);
